...
<head>
    ...
    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Agbalumo&family=Rubik+Mono+One&display=swap" rel="stylesheet">


    <link rel="preconnect" href="https://fonts.googleapis.com">
    <link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
    <link href="https://fonts.googleapis.com/css2?family=Agbalumo&family=Carter+One&family=Rubik+Mono+One&display=swap" rel="stylesheet">
    

    <link rel="stylesheet" href="css/regresiva.css">
    ...
    <header class="hero">
        ...
        <nav class="nav">
            <div class="nav_container container">
                <img class="nav_insignea" src="imagen/insignea.png" >
                <div class="logo">
                    <h3 class="colegio">Colegio</h3>
                ...
                <div class="nav_link" id="open">
                    ...
                    <a href="noticias/login.php" class="nav_link_menu">Intranet</a>
                </div>
    ...
    <main class="main">
        ...
        <section class="propuestas_lista">
            <div class="n_propuesta">
                ...
                <h2 class="n_propuesta_titulo">Educación Científica</h2>
                <p class="n_propuesta_parrafo">"Desarrollar pensamiento crítico mediante investigación y experimentación, aplicando el método científico para resolver problemas reales con rigor y creatividad."</p>
                <a href="#" class="n_propuesta_link">Leer más</a>
            </div>

            <div class="n_propuesta">
                <img src="imagen/foto03.jpg" alt="" class="n_propuesta_img">
                <h3 class="n_propuesta_titulo">Educación Humanística </h3>
                <p class="n_propuesta_parrafo">"Fomentar valores éticos y conciencia social a través del estudio de filosofía, arte e historia, formando ciudadanos reflexivos y comprometidos."</p>
                <a href="#" class="n_propuesta_link">Leer más</a>
            </div>

            <div class="n_propuesta">
                <img src="imagen/foto04.jpg" alt="" class="n_propuesta_img">
                <h3 class="n_propuesta_titulo">Educación Tecnológico</h3>
                <p class="n_propuesta_parrafo">"Impulsar competencias digitales y pensamiento computacional, integrando programación e inteligencia artificial para innovar con responsabilidad en la era digital."</p>
                <a href="#" class="n_propuesta_link">Leer más</a>
            </div>
        </section>
...
<!----------------------- apartado NOTICIAS------------------------>
    ...
    <footer class="footer">
        <div class="footer_logo">
            <div class="footer_logo_titulo">
                ...
                <h3 class="f_maynas">EPT-MAYNAS</h3>
            </div>
    ...
    <div id="countdownModal" class="modal">
        <div class="modal-content">
            <div class="modal-header">
                <h1 class="modal_titulo">Felices Fiestas Patrias 2025</h1>
                <span class="close">&times;</span>
            </div>
            <div class="modal-body">
                <div class="event-image">
                    <img src="imagen/FIESTAS_PATRIAS00.jpg" alt="Evento 28 de Julio 2025">
                </div>
                ...
                <div class="event-description">
                    <p>No te pierdas el evento más importante del año</p>
                </div>
            </div>
        </div>
    </div>
 ...
 <!-- Botón para abrir el chat -->
    ...
    <script src="js/regresiva.js"></script>
